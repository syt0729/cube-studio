...
def detect(img_path, save_img=True):
    # YOLO_WEIGHTS_PATH = os.getenv('YOLO_WEIGHTS_PATH','mnt/admin/coco_data_sample/yolov7_best.weights')
    
    # source, weights, view_img, save_txt, imgsz, trace = source, weights, view_img, save_txt, img_size, not no_trace
    source = img_path
    weights = '/yolov7/yolov7_best.pt'
    imgsz = 640
    trace = True
    save_txt = False
    webcam = False
