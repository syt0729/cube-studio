...
# @pysnooper.snoop()
def download_file(url, des_dir=None, overwrite='True', local_path=None):
    ...
    with requests.get(url, stream=True) as r:
        ...
        r.close()
# @pysnooper.snoop()
def download(name,version,save_dir,**kwargs):
    print('name ', name)
...
if __name__ == "__main__":
    ...
    download_file(url='https://docker-76009.sz.gfp.tencent-cloud.com/github/cube-studio/pipeline/coco_data_sample.zip', 
                #   des_dir='/mnt/admin/pipeline/example/dataset/',
                  des_dir='./abc/',
                  overwrite="True")



# /home/yons/Desktop/cube-studio/job-template/custom-jobs/dataset(hostpath):/app
