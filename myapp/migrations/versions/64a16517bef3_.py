...
Revision ID: 64a16517bef3
Revises: e705d2207219
Create Date: 2024-07-17 16:47:58.633059
...
revision = '64a16517bef3'
down_revision = 'e705d2207219'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('dataset', schema=None) as batch_op:
        if not batch_op.has_column('project_id'):
              batch_op.add_column(sa.Column('project_id', sa.Integer(), nullable=False, comment='项目组id'))
